...
for relative in ["references/current-state-analysis.md", "references/migration-strategy.md", "references/risk-control.md", "templates/current-state-audit.md", "templates/refactor-plan.md", "templates/regression-matrix.md"]:
    if not (ROOT / relative).is_file():
        raise SystemExit(f"missing resource: {relative}")
print("existing-project-refactoring: valid")
